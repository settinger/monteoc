...
exec(
  ...
  (initErr, initStdout, initStderr) => {
    ...
    // npm will remove the .gitignore file when the package is installed, therefore it cannot be copied, locally and needs to be downloaded.
    https.get(
      "https://raw.githubusercontent.com/settinger/monteoc/main/.gitignore",
      (res) => {
